...
**SSHH فقط یک «کلاینت» است** — یعنی خودش **سرور یا اکانت نمی‌دهد**.
این برنامه مثل یک مدیریت‌کننده‌ی تونل SSH عمل می‌کند: **شما سرور SSH خودتان را تهیه می‌کنید** و SSHH آن را با یک کلیک به یک VPN/پروکسی امن روی ویندوز تبدیل می‌کند.
